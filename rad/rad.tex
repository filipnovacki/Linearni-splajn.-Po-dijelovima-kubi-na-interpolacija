...
\chapter{Zadaci}
	...
	Newtonova forma nam je korisna jer lako dodajemo nove točke interpolacije i na taj način povećavamo stupanj interpolacijskog polinoma. 
	...
	Interpolacijski polinom stupnja 2 nastaje tako da dodamo još jedan čvor interpolacije $x_2$. Sada polinom $p_2$ dobijemo tako da polinomu $p_1$ dodamo korekciju $c_2$.
	\begin{equation*}
		p2(x)=p_1(x)+c_2(x)
	\end{equation*}
